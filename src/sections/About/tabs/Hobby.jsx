...
const Hobby = () => {
  return (
    <div className="space-y-8 animate-fade-in font-montserrat">
        ...
        {/* Phần sở thích (Tags) */}
        <div>
            <h3 className="text-2xl font-bold text-text-main font-spartan mb-4">Beyond Coding</h3>
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 h-48">
                <div className="bg-bg-surface/10 rounded-xl flex items-center justify-center border border-dashed border-text-muted/30">
                    <span className="text-text-muted/40">Image 1</span>
                </div>
                <div className="bg-bg-surface/10 rounded-xl flex items-center justify-center border border-dashed border-text-muted/30">
                     <span className="text-text-muted/40">Image 2</span>
                </div>
            </div>
        </div>

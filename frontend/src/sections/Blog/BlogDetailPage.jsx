...
const BlogDetailPage = () => {
  ...
  if (!post)
    return <div className="text-white text-center pt-32">Post not found</div>;
              ...
              <div className="markdown-content text-text-muted/90 text-lg leading-relaxed space-y-6">
                <ReactMarkdown
                  ...
                  components={{
                    h1: ({ node, ...props }) => (
                      <h1
                        className="text-3xl font-bold text-text-main mt-10 mb-4"
                        {...props}
                      />
                    ),
                    h2: ({ node, ...props }) => (
                      <h2
                        className="text-2xl font-bold text-text-button mt-8 mb-4 border-l-4 border-text-button pl-4"
                        {...props}
                      />
                    ),
                    ...
                    code({ node, inline, className, children, ...props }) {
                      ...
                      return !inline && match ? (
                        ...
                        <code
                          className="bg-white/10 text-text-button px-1.5 py-0.5 rounded font-mono text-sm"
                          {...props}
                        >
                          {children}
                        </code>
